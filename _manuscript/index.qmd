...
We adhere to research transparency principles that are crucial for robust and replicable science. First, we reported how we determined the sample size, all data exclusions, all manipulations, and all study measures. We provide a Transparency Report [@aczelConsensusbasedTransparencyChecklist2019] in the supplement. Second, our features, labels, questionnaires, and other study materials are publicly available on our Open Science Framework (OSF) page ([https://osf.io/wgpz9/](https://osf.io/wgpz9/)). Finally, the annotated analysis scripts are publicly available on our study website ([https://jjcurtin.github.io/study_messages/](https://jjcurtin.github.io/study_messages/)).
