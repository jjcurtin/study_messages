...
```{r}
#| label: tbl-1
#| tbl-cap: "Raw Predictors, Response Options, Feature Engineering Methods, Scoring Epochs, Total Number of Features, and Indication of Inclusion in Full and Baseline Models"
