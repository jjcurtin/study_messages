...
harmful drinking
{[}\textbf{marlattRelapsePreventionMaintenance1985?},\textbf{marlattRelapsePreventionSecond2007?}{]}.
While lapses can occur at any point in recovery, they are particularly
risky during early recovery
{[}\textbf{daleyReducingRiskRelapse2019?}{]}. Protective coping
mechanisms and socio-environmental resources that support recovery are
dynamic and accumulate over time
{[}\textbf{clevelandRecoveryRecoveryCapital2021?}{]}. As a result, early
...
predictions {[}4{]}. Early machine learning models using ecological
...
{[}8,\textbf{jonesComplianceEcologicalMomentary2019?}{]}. It is unclear
...
measures. We provide a transparency checklist {[}9{]} in the supplement.
Second, our features, labels, questionnaires, and other study materials
are publicly available on our Open Science Framework (OSF) page
(\url{https://osf.io/wgpz9/}). Finally, the annotated analysis scripts
are publicly available on our study website
...
analysis methods for logistic regression {[}10{]} because comparable
...
count, personality {[}12{]}, and psychiatric symptoms {[}11,13{]}). At
the intake visit, approximately two weeks after screening, we collected
additional self-report data on abstinence self-efficacy {[}14{]},
craving {[}15{]}, and recent recovery efforts and goals.
...
EMA questions were used as features in other studies {[}6,7{]}, but were
outside the scope of this cellular communication sensing study.
...
communication method {[}16{]}. Therefore, our dataset likely missed a
...
{[}17{]} and predict future {[}18{]} heavy drinking episondes in
