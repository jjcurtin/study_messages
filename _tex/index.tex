...
demographic and self-report measures retained five features and
demonstrated nearly identical performance (median auROC = 0.68, 95\% CI
{[}0.64, 0.71{]}). Conclusions: Cellular communication data capture some
...
selected using 6 repeats of participant-grouped 5-fold cross-validation.
Our performance metric was area under the receiver operating curve
(auROC). Folds were stratified so that all folds contained comparable
proportions of individuals who lapsed frequently (i.e., 10+ times).
