...
from alcohol at the time of the screening visit, had been abstinent for
1--8 weeks, were willing to use a single smartphone, and were not
exhibiting severe psychosis or paranoia.\footnote{Defined as scores
  \textgreater2.2 or 2.8, respectively, on the psychosis or paranoia
  scales of the Symptom Checklist--90\textsuperscript{14}.}
...
symptom count, alcohol problems\textsuperscript{15}, and presence of
psychological symptoms\textsuperscript{14}). At the intake visit,
roughly two weeks after screening, we collected additional self-report
data on abstinence self-efficacy\textsuperscript{16},
craving\textsuperscript{17}, and recent recovery efforts and goals.
...
and self-report measures were collected for the parent grant. The full
study protocol is available on our Open Science Framework page
...
outcome, conditional on the other features retained. All our annotated
...
communication method\textsuperscript{18}. Therefore, our dataset likely
...
current\textsuperscript{19} and predict future\textsuperscript{20} heavy
