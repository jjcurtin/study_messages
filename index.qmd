...
<!-- CY: still work on this -->To enhance the effectiveness of smart DTx, those predictive modeling should be accurate and temporally precise. More specifically, they should be capable of detecting increased lapse risks in a timely manner. These predictions allow windows for subsequent just-in-time intervention to prevent lapses targeting a specific person. Alcohol relapse risks are dynamic and thus require continuing monitoring and just-in-time intervention when needed. Some relapse factors (e.g., drinking partner, drinking behavior) are situated and can be fluctuating over time. They usually occurs before an episode of alcohol use [@chihPredictiveModelingAddiction2014a]. They can be elusive to therapists' attention due to infrequent visits, highlighting importance of sustained monitoring to prevent lapses.
