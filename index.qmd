...
|---------------|---------------|---------------|---------------|---------------|
| `r fairness$group[1]` | `r fairness$median[1]` | `r fairness$lower[1]` | `r fairness$upper[1]` | `r fairness$probability[1]` |
| `r fairness$group[2]` | `r fairness$median[2]` | `r fairness$lower[2]` | `r fairness$upper[2]` | `r fairness$probability[2]` |
| `r fairness$group[3]` | `r fairness$median[3]` | `r fairness$lower[3]` | `r fairness$upper[3]` | `r fairness$probability[3]` |
| `r fairness$group[4]` | `r fairness$median[4]` | `r fairness$lower[4]` | `r fairness$upper[4]` | `r fairness$probability[4]` |
