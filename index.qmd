...
<!--I dont think I understand context enough from the text and table either.  We need to know how it was collected and on who (only frequent contacts).   We then need to know that numbers are linked to these contacts so you can count them but that the features that dont use context are for all contacts, regardless if they are a frequent person--><!--KW: I tried to make this more clear in procedure section and this section. Let me know if it does not come through. We filtered out data from unknown contacts prior to feature engineering so those logs are not included even in generic features-->
