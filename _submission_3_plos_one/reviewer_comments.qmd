...
Regarding potential interactions, see reviewer response 4. 
...
<!--interesting but we would need to create features from EMA items to address this. For the goals of this study we restricted our sensing features to those that could be derived from cellular communication data.-->
