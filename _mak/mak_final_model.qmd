...
params:
  ...
  version: "v21"
  cv: "kfold"
  model: "meta" # full, baseline, meta, or passive
editor_options: 
...
if (batch == "baseline") {
  d <- d |>
    select(-c(sms.p24.l0.rratecount.originated.incoming:voice.p168.l0.dratecount_datetime.dttm_obs.fri_sat)) |> 
    select(-starts_with("mps_"), -starts_with("dass_"))
}
