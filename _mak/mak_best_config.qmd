...
- v1: initial version of all liwc categories (auroc = 0.5677741)

- v3: cut liwc categories in half (auroc = 0.5746350)

- v4: added Sarah's liwc categories (auroc = 0.5560656)

- v4: random forest of v3 (auroc = 0.5786700)
