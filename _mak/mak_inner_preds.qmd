...
#   new_name <- gsub("p6.l0.rratesum_duration.", "p6.raw_duration.", new_name)
#   new_name <- gsub("p12.l0.rratesum_duration.", "p12.raw_duration.", new_name)
#   new_name <- gsub("p24.l0.rratesum_duration.", "p24.raw_duration.", new_name)
#   new_name <- gsub("p48.l0.rratesum_duration.", "p48.raw_duration.", new_name)
#   new_name <- gsub("p72.l0.rratesum_duration.", "p72.raw_duration.", new_name)
#   new_name <- gsub("p168.l0.rratesum_duration.", "p168.raw_duration.", new_name)
#   new_name <- gsub("p6.l0.dratesum_duration.", "p6.diff_duration.", new_name)
#   new_name <- gsub("p12.l0.dratesum_duration.", "p12.diff_duration.", new_name)
#   new_name <- gsub("p24.l0.dratesum_duration.", "p24.diff_duration.", new_name)
#   new_name <- gsub("p48.l0.dratesum_duration.", "p48.diff_duration.", new_name)
#   new_name <- gsub("p72.l0.dratesum_duration.", "p72.diff_duration.", new_name)
#   new_name <- gsub("p168.l0.dratesum_duration.", "p168.diff_duration.", new_name)
...
#   new_name <- gsub("p72.drvar_location", "p72.diff_location_variance", new_name)
...
if(!file.exists(here::here(path_models, str_c("inner_preds_", 
  ...
  inner_split_num_list <- rep(1:2, times = 1)
  outer_split_num_list <- rep(1, each = 2)
...
if(!file.exists(here::here(path_models, str_c("inner_shapsgrp_",
  ...
  shaps_out_grp |>  write_rds(here::here(path_models, 
                                          str_c("inner_shapsgrp_", window, "_", 
                                                lead, "_", version, "_",
                                                cv, "_", model, ".rds")))
}
```
